<template>
    <div id="nav">
        ...
        <nav class="navbar navbar-dark fixed-top bg-dark navbar-expand-lg">
                <router-link to="/" class="navbar-brand">AiTraffic</router-link>               
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" @click="openn">图片相册</a>
                    </li>
                    <!-- <li class="nav-item">
                        <a class="nav-link" href="../../hello.html">图片相册</a>
                    </li> -->
                </ul>
            </div>
        </nav> 
...
import 'bootstrap'
    export default {
		...
		methods:{
			openn(){
                window.location.href='../../picture/demo.html'
